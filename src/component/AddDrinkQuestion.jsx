...
const AddDrinkQuestion = ({question,setQuesAns,currectQuestion,setCurrentQuestion}) => {

    const [correctAns,setCorrectAns] = useState('');
    const [options,setOptions] = useState();

    const generateRandomOptions = (correct) => {
        const randomOptions = ["Water", "Coffee", "Tea", "Juice", "Soda", "Smoothies","Milkshakes","Bubble Tea","Lemonade","Beer","Wine","Cocktails","Spirits"];
            ...
            <div className='pt-0'>
                <div className="card-options p-6">
                    <select
                        ...
                        <option style={{display:'none'}}>Select Vale</option>
                        {
                            ["Water", "Coffee", "Tea", "Juice", "Soda", "Smoothies","Milkshakes","Bubble Tea","Lemonade","Beer","Wine","Cocktails","Spirits"].map((option, index) => (
...
export default AddDrinkQuestion