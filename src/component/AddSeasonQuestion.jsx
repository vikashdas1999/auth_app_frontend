...
const AddSeasonQuestion = ({question,setQuesAns,currectQuestion,setCurrentQuestion}) => {

    const [correctAns,setCorrectAns] = useState('');
    const [options,setOptions] = useState();

    const generateRandomOptions = (correct) => {
        const randomOptions = ['Spring', 'Summer', 'Autumn (or Fall)', 'Winter', 'None', 'A specific holiday season'];
            ...
            <div className='pt-0'>
                <div className="card-options p-6">
                    <select
                        ...
                        {
                            ['Spring', 'Summer', 'Autumn (or Fall)', 'Winter', 'None', 'A specific holiday season'].map((option, index) => (
...
export default AddSeasonQuestion